  ...
  layers: [Basemap,
    new ol.layer.Tile({
     ...
     new ol.layer.Tile({
			...
			LegentType :'ESRI',
			InfoPopup : false,
			metadata : 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_GEOPARK_5K/MapServer/info/iteminfo',
			visible: true
	 }),
     new ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
			...
			LegentType :'ESRI',
			InfoPopup : false,
			metadata : 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_IDM_2021_PENDAPATAN_DESA_AR/MapServer/info/iteminfo',
			visible: true
	 })
  ],
  target: 'map',
